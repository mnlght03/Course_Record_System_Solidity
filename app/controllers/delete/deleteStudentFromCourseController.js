...
async function deleteStudentFromCourseController(req, res) {
  ...
  try {
    ...
    const result = await courseSystem.deleteStudentFromCourseController(studentAddress, courseId)
...
module.exports = deleteStudentFromCourseController