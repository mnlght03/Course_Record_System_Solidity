...
async function makeCourseAvailableController(req, res) {
  ...
  try {
    ...
    const result = await courseSystem.makeCourseAvailableForGroup(courseId, groupId)
...
module.exports = makeCourseAvailableController