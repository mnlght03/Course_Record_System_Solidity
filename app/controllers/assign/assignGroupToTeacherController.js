...
async function assignGroupToTeacherController(req, res) {
  ...
  try {
    ...
    const result = await courseSystem.assignGroupToCourseTeacher(groupId, courseId, teacher)
...
module.exports = assignGroupToTeacherController