...
async function changeCourseController(req, res) {
  ...
  try {
    ...
    const result = await courseSystem.changeCourseInTimetable(day, numberOfLesson, courseId)
...
module.exports = changeCourseController