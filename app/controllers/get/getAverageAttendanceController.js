...
async function getAverageAttendanceController(req, res) {
  ...
  try {
    ...
    const result = await courseSystem.getAverageAttendance(courseId, studentAddress)
...
module.exports = getAverageAttendanceController